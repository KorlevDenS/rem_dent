                ...
                <Paper elevation={3} sx={{
                    ...
                    <List sx={{ listStyleType: "disc", pl: {xs: 0, sm: 2, md: 4} }}>
                     ...
                     (ФИО, телефон, email и др.). Информация носит исключительно ознакомительный характер." />
                        ...
                        <ListItem sx={{ display: "list-item" }}>
                            <ListItemText primary="Для работы виджета Яндекс Карт сайт использует технические файлы
                            cookie. Они необходимы исключительно для корректного отображения карты и не используются
                            для сбора персональной информации вне этого функционала" />
                        </ListItem>
                        <ListItem sx={{ display: "list-item" }}>
